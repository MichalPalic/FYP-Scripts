...
parser.add_argument('--gem5dir',
                type=str,
                default="/home/michal/Desktop/gem5_sspp",
...
parser.add_argument('--resultdir',
                type=str,
                default="/home/michal/Desktop/spec_2017_rate_sweep_branches_deepjseng",
...
for branch in [0, 1, 2, 4, 8, 16, 32, 64]:
    for clearmult in [0.003906, 0.015625, 0.0625, 0.25, 1]:
        for checkpoint_path in checkpoint_paths:
            
            #Only run deepjseng 
            if not ("531." in checkpoint_path or "525." in checkpoint_path \
                    or "520." in checkpoint_path or "544." in checkpoint_path):
                continue
            ...
            result_dir = f"{args.resultdir}/{branch}_{clearmult}/{spec_name}/{spec_idx}/{checkpoint_idx}"
            ...
            command.extend([f'{args.gem5dir}/build/X86/gem5' + ('.debug' if args.debug
                            ...
                            f"--ssit-branch-history-length={branch}",
